...
INSERT INTO "new_HusbandryRecord" ("createdAt", "humidity", "id", "length", "reptileId", "temperature", "updateAt", "weight") SELECT "createdAt", "humidity", "id", "length", "reptileId", "temperature", "updateAt", "weight" FROM "HusbandryRecord";
